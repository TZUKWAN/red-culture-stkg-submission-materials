...
| **加权总体 STRICT 机会率**（还原至 311,992） | **0.0066** | **[0.0040, 0.0097]**（stratified bootstrap B=10,000，seed=20260916） | 点估计 ≈2,070 条；**条数区间 [1,257, 3,019]** |
...
**问题 8 答案**：最终 STRICT precision = **0.9928 = 965/972**（95%CI [0.9852, 0.9965]；强共识误报率 0.41% = 4/972，95%CI [0.0016, 0.0105]）。
